...
namespace ControlPanel.Controllers
{
    ...
    public class CompaniesController : Controller
    {
        ...
        {
            ViewBag.CompanyUserId = new SelectList(db.Users.Where(a=>a.companyUser), "Id", "Name");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "id,name,isActive,CompanyUserId")] Company company)
        {
            ...
            {
                ApplicationUser user = db.Users.Find(company.CompanyUserId);
        ...
        public ActionResult Edit(int? id)
        {
            ...
            ViewBag.CompanyUserId = new SelectList(db.Users, "Id", "Name");
            return View(company);
        }
        ...
        public ActionResult Edit([Bind(Include = "id,name,isActive,CompanyUserId")] Company company)
        {
            if (ModelState.IsValid)
            {
                Company temp = db.Companies.Find(company.id);
                ApplicationUser user = db.Users.Find(company.CompanyUserId);
                temp.CompanyUser = user;
